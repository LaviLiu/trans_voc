...
train_data = "/home/lavi/gttolmdb/result/people_detection/people_detection_train_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
#test_data = "examples/VOC0712/VOC0712_test_lmdb"
test_data = "/home/lavi/gttolmdb/result/people_detection/people_detection_test_lmdb"
...
save_dir = "models/{}/people_detection/{}".format(model_prefix, job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/{}/people_detection/{}".format(model_prefix,job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/{}/people_detection/{}".format(model_prefix,job_name)
# Directory which stores the detection results.
output_result_dir = "results/people_detection/{}/Main".format(os.environ['HOME'], job_name)
...
name_size_file = "/home/lavi/gttolmdb/result/people_detection/test_name_size.txt"

#pretrain_model = "models/pelee/VOC0712/SSD_304x304/pelee_SSD_304x304_iter_200000.caffemodel"
pretrain_model = ""

# Stores LabelMapItem.
#label_map_file = "data/VOC0712/labelmap_voc.prototxt"
label_map_file = "/home/lavi/gttolmdb/result/people_detection/labelmap_people_detection.prototxt"
...
with open(job_file, 'w') as f:
  ...
  f.write('/home/lavi/caffe/build/tools/caffe train \\\n')
  f.write('--solver="{}" \\\n'.format(solver_file))
